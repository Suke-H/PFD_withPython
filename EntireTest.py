...
from CheckViewer import ViewTest
...
def simulation(sign_type, scale, density, noise_rate, error_rate, error_step, out_path):
    ...
    # 外枠生成
    out_points, out_area = MakeOuterFrame(points2d, out_path, 0, 
                              dilate_size=50, close_size=20, open_size=70, add_size=20)
    ...
    #best = GA(sign)
    # print("GA開始")
    best_circle = EntireGA(points2d, out_points, out_area, CalcIoU1, out_path+"/GA/circle.png", fig_type, 
                            fig=[0], n_epoch=100, N=100, add_num=30, half_reset_num=10, all_reset_num=5)

    best_tri = EntireGA(points2d, out_points, out_area, CalcIoU1, out_path+"/GA/tri.png", fig_type, 
                            fig=[1], n_epoch=300, N=100, add_num=30, half_reset_num=15, all_reset_num=9)

    best_rect = EntireGA(points2d, out_points, out_area, CalcIoU1, out_path+"/GA/rect.png", fig_type, 
                            fig=[2], n_epoch=600, N=100, add_num=30, half_reset_num=30, all_reset_num=10)
    ...
    ViewTest(points3d, trueIndex,  # 点群
            ...
            opti_para2d, opti_fig_type, opti_plane_para, opti_u, opti_v, opti_O, opti_AABB2d)
